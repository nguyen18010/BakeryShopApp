...
public class ChiTietDonHangAdapter_Admin extends ArrayAdapter<ChiTietDonHang> {
    public ChiTietDonHangAdapter_Admin(Context context, List<ChiTietDonHang> details) {
