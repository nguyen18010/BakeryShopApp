...
public class ChiTietDonHang_Admin_Activity extends AppCompatActivity {
    ...
    ChiTietDonHangAdapter_Admin chiTietAdapter; // Adapter để hiển thị chi tiết
        ...
        if (donHangIdStr != null) {
            try {
                ...
                if (chiTietList != null && !chiTietList.isEmpty()) {
                    ...
                    chiTietAdapter = new ChiTietDonHangAdapter_Admin(this, chiTietList);
            ...
            if (allChiTietList != null && !allChiTietList.isEmpty()) {
                chiTietAdapter = new ChiTietDonHangAdapter_Admin(this, allChiTietList);
