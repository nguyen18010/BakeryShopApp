...
public class ChiTietDonHang_NguoiDung_Activity extends AppCompatActivity {

    DatabaseHelper dbdata;
    Database database;
    ListView listViewChiTiet; // Danh sách hiển thị chi tiết đơn hàng
    ChiTietDonHangAdapter_NguoiDung chiTietAdapter; // Adapter để hiển thị chi tiết
    String tendn; // Biến để lưu tên đăng nhập

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_chi_tiet_don_hang_nguoidung);
        ...
        if (tendn != null) {
            ...
            Intent intent = new Intent(ChiTietDonHang_NguoiDung_Activity.this, Login_Activity.class);
        ...
        if (donHangIdStr != null) {
            try {
                ...
                if (chiTietList != null && !chiTietList.isEmpty()) {
                    ...
                    chiTietAdapter = new ChiTietDonHangAdapter_NguoiDung(this, chiTietList, tendn);
            ...
            if (allChiTietList != null && !allChiTietList.isEmpty()) {
                chiTietAdapter = new ChiTietDonHangAdapter_NguoiDung(this, allChiTietList, tendn);
